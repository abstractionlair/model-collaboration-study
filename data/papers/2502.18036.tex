...
Qianren Mao\textsuperscript{\rm 2}, 
Ming Li\textsuperscript{\rm 5}, 
Likang Xiao\textsuperscript{\rm 1}, 
Dingqi Yang\textsuperscript{\rm 6}, 
Yikun Ban\textsuperscript{\rm 1}, 
Hailong Sun\textsuperscript{\rm 1,*}, 
Philip S. Yu\textsuperscript{\rm 7,*}
    \affiliations
    ...
    \textsuperscript{\rm 4}Xi’an Jiaotong University, Xi’an, China\\
        \textsuperscript{\rm 5}Tsinghua University, Beijing, China\\
    \textsuperscript{\rm 6}University of Macau, Macau SAR, China\\
    \textsuperscript{\rm 7}University of Illinois at Chicago, Chicago, USA\\
    \emails{
    \{zhijunchen, jingzhengli, chenpp, lizhuoranget, sunkai, luoyk, xiaolik, yikunb, sunhl\}@buaa.edu.cn,  maoqr@zgclab.edu.cn, mingli\_thu@tsinghua.edu.cn,
...
\faGithub~\href{https://github.com/junchenzhi/Awesome-LLM-Ensemble}{
  \textcolor[rgb]{0.0, 0.4039, 0.5843}{https://github.com/junchenzhi/Awesome-LLM-Ensemble}
}

% \faGithub~\href{https://github.com/junchenzhi/Awesome-LLM-Ensemble}{
%   \textcolor{MidnightBlue}{https://github.com/junchenzhi/Awesome-LLM-Ensemble}
% }

% \faGithub~\href{https://github.com/junchenzhi/Awesome-LLM-Ensemble}{
%   \textcolor[rgb]{0.098, 0.098, 0.439}{https://github.com/junchenzhi/Awesome-LLM-Ensemble}
% }
\end{abstract}
...
\textbf{LLM Merging}, also known as \textbf{LLM Fusion}~\cite{yang2024model,yang2025cabs,ruan2025task}, integrates parameters from various LLMs to construct a universal model without requiring original training data or extensive computation. 
It is highly relevant to LLM Ensemble, as both promote knowledge fusion and transfer.

\textbf{LLM  Collaboration} leverages the distinct strengths of each model to approach tasks with increased flexibility~\cite{du2023improving,lu2024merge,chen2025survey,tran2025multi,zhang2025if}. 
...
\textbf{Weak Supervision}~\cite{zhang2021wrench,chen2023neural,zhang2022survey,ratner2017snorkel}, 
sometimes referred to as
\textbf{Learning from Crowds}~\cite{chen2021structured,chen2022adversarial,zhang2022knowledge}, uses weak labels contributed from multiple weak annotation sources to perform information aggregation~\cite{chen2023black,zheng2017truth} (corresponding \textit{non-cascade ensemble after inference} in LLM Ensemble) or directly train a classifier~\cite{zhang2021wrench}, yet most methods focus on classification
rather than general open-ended generation tasks.
...
\cellcolor[rgb]{ .867, .922, .969}\cite{shnitzer2023large}  & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance & \cellcolor[rgb]{ .867, .922, .969}Binary CE loss&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\xmark&\cellcolor[rgb]{ .867, .922, .969}-\\
  &
\cite{srivatsa2024harnessing}   & Un-/Supervised &Performance & Class-balanced CE loss/Clustering&Reasoning&\cmark&\href{https://github.com/kvadityasrivatsa/llm-routing}{\textcolor{gray}{[Link]}}\\
  &
\cellcolor[rgb]{ .867, .922, .969}\cite{ong2024routellm}  & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance and cost & \cellcolor[rgb]{ .867, .922, .969}Binary CE loss&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/lm-sys/RouteLLM}{\textcolor{gray}{[Link]}}\\
  &
Hybrid-LLM~\cite{dinghybrid}  & Supervised &Performance and cost & Binary CE loss&Generation&\xmark&\href{ https://github.com/m365-core/hybrid_llm_routing}{\textcolor{gray}{[Link]}}\\
  &
\cellcolor[rgb]{ .867, .922, .969}SelectLLM \cite{maurya2024selectllm}   & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance, cost & \cellcolor[rgb]{ .867, .922, .969}Class-balanced CE loss&\cellcolor[rgb]{ .867, .922, .969}Understanding/Reasoning&\cellcolor[rgb]{ .867, .922, .969}\xmark&\cellcolor[rgb]{ .867, .922, .969}-\\
  &
Routoo~\cite{mohammadshahi2024routoo}  & Supervised& Performance and cost &CE loss&  Classification&\xmark&-\\

  &
\cellcolor[rgb]{ .867, .922, .969}Zooter~\cite{lu2024routing}   & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance & \cellcolor[rgb]{ .867, .922, .969}KL divergence&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}-\\
...
Bench-CoE~\cite{wang2024bench}   & Supervised &Performance&  CE loss&Generation&\cmark&\href{https://github.com/ZhangXJ199/Bench-CoE}{\textcolor{gray}{[Link]}}\\
  &
\cellcolor[rgb]{ .867, .922, .969}\cite{li2025llm}   & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance and cost & \cellcolor[rgb]{ .867, .922, .969}Negative log-likelihood loss&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}-\\
  &
MetaLLM~\cite{nguyen2024metallm}  & Supervised &Performance & Mean square error& Classification&\xmark&\href{https://github.com/mail-research/MetaLLM-wrapper/}{\textcolor{gray}{[Link]}}\\
  &
\cellcolor[rgb]{ .867, .922, .969}TO-Router~\cite{stripelis2024tensoropera}   & \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Perf., cost and query time & \cellcolor[rgb]{ .867, .922, .969}KL divergence&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}-\\
  &
FORC~\cite{vsakota2024fly}& Supervised &Performance and cost & Avg. of multi-metric integration&Generation&\cmark&\href{https://github.com/epfl-dlab/forc}{\textcolor{gray}{[Link]}}\\
  &
\cellcolor[rgb]{ .867, .922, .969}HomoRouter~\cite{mu2024adaptive}& \cellcolor[rgb]{ .867, .922, .969}Supervised &\cellcolor[rgb]{ .867, .922, .969}Performance and cost & \cellcolor[rgb]{ .867, .922, .969}Mean square error &\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}-\\
...
Eagle~\cite{zhao2024eagle} & Unsupervised & Performance and cost & - & Generation  &\xmark&-\\
 &
\cellcolor[rgb]{ .867, .922, .969}PickLLM~\cite{sikeridis2024pickllm}  &\cellcolor[rgb]{ .867, .922, .969}Supervised & \cellcolor[rgb]{ .867, .922, .969}Perf., cost and query time& \cellcolor[rgb]{ .867, .922, .969}-&\cellcolor[rgb]{ .867, .922, .969}Generation&\cellcolor[rgb]{ .867, .922, .969}\cmark&\cellcolor[rgb]{ .867, .922, .969}- \\
...
In the retrieval-augmented generation (RAG) scenario, given a set of homogeneous search tools and user queries, HomoRouter~\cite{mu2024adaptive} is trained to predict the score of the LLM calling each tool to process the 
% query,
% and then the query is assigned to the best tool according to different allocation strategies.
...
\midrule
\multirow{8}{*}{(b1)} &
\cellcolor[rgb]{ .867, .922, .969}GaC~\cite{yu2024breaking} &\cellcolor[rgb]{ .867, .922, .969}Token  & \cellcolor[rgb]{ .867, .922, .969}Averaging agg.,Vocabulary align.  &\cellcolor[rgb]{ .867, .922, .969}\cmark   &\cellcolor[rgb]{ .867, .922, .969}$\geq 2$   &\cellcolor[rgb]{ .867, .922, .969}Union dictionary  &\cellcolor[rgb]{ .867, .922, .969}\xmark  & \cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/yaoching0/GaC}{\textcolor{gray}{[Link]}}\\
&
...
&
\cellcolor[rgb]{ .867, .922, .969}EVA~\cite{xu2024bridging}   & \cellcolor[rgb]{ .867, .922, .969}Token & \cellcolor[rgb]{ .867, .922, .969}Averaging agg.,Vocabulary align.  & \cellcolor[rgb]{ .867, .922, .969}\cmark  & \cellcolor[rgb]{ .867, .922, .969}$\geq 2$    & \cellcolor[rgb]{ .867, .922, .969}Relative representation  &  \cellcolor[rgb]{ .867, .922, .969}\xmark & \cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/xydaytoy/EVA}{\textcolor{gray}{[Link]}}\\
&

UniTe~\cite{yao2024determine} &Token  &Averaging agg.,TOP-K union   & \cmark  &$\geq 2$  & Union dictionary &\cmark  & Generation& \textcolor{gray}{-}\\

&
\cellcolor[rgb]{ .867, .922, .969}PackLLM~\cite{mavromatis2024pack} &\cellcolor[rgb]{ .867, .922, .969}Token  &\cellcolor[rgb]{ .867, .922, .969}Weighted avg. agg.,Perplexity   & \cellcolor[rgb]{ .867, .922, .969}\cmark &\cellcolor[rgb]{ .867, .922, .969}$\geq 2$  & \cellcolor[rgb]{ .867, .922, .969}Greedy optimization &\cellcolor[rgb]{ .867, .922, .969}\xmark  &\cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/cmavro/PackLLM}{\textcolor{gray}{[Link]}}\\
...
&
\cellcolor[rgb]{ .867, .922, .969}\cite{li2024purifying} &\cellcolor[rgb]{ .867, .922, .969}Token  &\cellcolor[rgb]{ .867, .922, .969}Weighted-averaging agg.   &\cellcolor[rgb]{ .867, .922, .969}\cmark  & \cellcolor[rgb]{ .867, .922, .969}$=2$ &  \cellcolor[rgb]{ .867, .922, .969}Reduce negative issues  &\cellcolor[rgb]{ .867, .922, .969}\xmark   & \cellcolor[rgb]{ .867, .922, .969}Generation &  \cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\

&
CITER~\cite{zheng2025citer} & Token &Token-Level routing (selection)   &\xmark  &$= 2$ &Reinforcement learning  &\cmark  & Generation& \href{https://github.com/aiming-lab/CITER}{\textcolor{gray}{[Link]}}\\

\cmidrule{2-10} 

\multirow{3}{*}{(b2)}
& 
\cellcolor[rgb]{ .867, .922, .969}Cool-Fusion~\cite{liu2024cool} &\cellcolor[rgb]{ .867, .922, .969}Span  & \cellcolor[rgb]{ .867, .922, .969}Generation-assessment-selection  & \cellcolor[rgb]{ .867, .922, .969}\cmark & \cellcolor[rgb]{ .867, .922, .969}$\geq 2$ &\cellcolor[rgb]{ .867, .922, .969}Perplexity, common words &\cellcolor[rgb]{ .867, .922, .969}\xmark  &\cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\
&
SweetSpan~\cite{xu2025hit}  & Span  &   Generation-assessment-selection &  \cmark &  $\geq 2$ &  Perplexity, fixed-length &  \xmark  & Generation &  \textcolor{gray}{-}\\
&
\cellcolor[rgb]{ .867, .922, .969}SpecFuse~\cite{lv2024specfuse}  &\cellcolor[rgb]{ .867, .922, .969}Span  &\cellcolor[rgb]{ .867, .922, .969}Generation-assessment-selection   & \cellcolor[rgb]{ .867, .922, .969}\cmark & \cellcolor[rgb]{ .867, .922, .969}$\geq 2$ & \cellcolor[rgb]{ .867, .922, .969}Perplexity, fixed-length & \cellcolor[rgb]{ .867, .922, .969}\cmark &\cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\

\cmidrule{2-10} 
\multirow{1}{*}{(b3)}
&
 LE-MCTS~\cite{park2024ensembling} & Process  &  Reasoning process selection  & \xmark  & $\geq 2$  &  Monte Carlo Tree 
Search &  \xmark  & Reasoning & \textcolor{gray}{-} \\
\bottomrule
\end{tabular}
}
\begin{tablenotes}
...
\midrule
\multirow{6}{*}{(c1)}
&\cellcolor[rgb]{ .867, .922, .969}Agent-Forest~\cite{li2024more}  & \cellcolor[rgb]{ .867, .922, .969}Unsupervised & \cellcolor[rgb]{ .867, .922, .969}Similarity-based selection & \cellcolor[rgb]{ .867, .922, .969}$ >  2$& \cellcolor[rgb]{ .867, .922, .969} Scaling property & \cellcolor[rgb]{ .867, .922, .969}\xmark &  \cellcolor[rgb]{ .867, .922, .969}Cls./Generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/MoreAgentsIsAllYouNeed/AgentForest}{\textcolor{gray}{[Link]}}\\
...
&\cellcolor[rgb]{ .867, .922, .969}MoRE~\cite{si2023getting} & \cellcolor[rgb]{ .867, .922, .969}Supervised & \cellcolor[rgb]{ .867, .922, .969} 
Supervised Sim.-based sel. & \cellcolor[rgb]{ .867, .922, .969}$ >  2$  & \cellcolor[rgb]{ .867, .922, .969}Feature engineering & \cellcolor[rgb]{ .867, .922, .969}\xmark&\cellcolor[rgb]{ .867, .922, .969}  Reasoning & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/NoviScl/MoRE}{\textcolor{gray}{[Link]}}\\
...
&\cellcolor[rgb]{ .867, .922, .969}LLM-TOPLA~\cite{tekin2024llm}  & \cellcolor[rgb]{ .867, .922, .969}Supervised & \cellcolor[rgb]{ .867, .922, .969}Selection-then-regeneration  & \cellcolor[rgb]{ .867, .922, .969}$ >  2$  & \cellcolor[rgb]{ .867, .922, .969}  Maximising diversity & \cellcolor[rgb]{ .867, .922, .969}\xmark & \cellcolor[rgb]{ .867, .922, .969}Generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/git-disl/llm-topla}{\textcolor{gray}{[Link]}}\\

&URG~\cite{lv2024urg}  & Supervised & Selection-then-regeneration & $ >  2$ & Unified processes &\cmark & Cls./Generation & -\\
\cmidrule{2-9} 
\multirow{10}{*}{(c2)}  & \cellcolor[rgb]{ .867, .922, .969}EcoAssistant~\cite{zhang2023ecoassistant} 	& \cellcolor[rgb]{ .867, .922, .969}Unsupervised & \cellcolor[rgb]{ .867, .922, .969}User judgment & \cellcolor[rgb]{ .867, .922, .969}$\geq 2$ & \cellcolor[rgb]{ .867, .922, .969}Prompt engineering & \cellcolor[rgb]{ .867, .922, .969}\cmark & \cellcolor[rgb]{ .867, .922, .969}Code generation & \cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/JieyuZ2/EcoAssistant}{\textcolor{gray}{[Link]}}\\
...
&  \cellcolor[rgb]{ .867, .922, .969}Model Cascading~\cite{varshney2022model}	& \cellcolor[rgb]{ .867, .922, .969}Unsupervised & \cellcolor[rgb]{ .867, .922, .969}Class uncertainty &  \cellcolor[rgb]{ .867, .922, .969}$\geq 2$  & \cellcolor[rgb]{ .867, .922, .969}Cascade-pioneer &\cellcolor[rgb]{ .867, .922, .969}\cmark & \cellcolor[rgb]{ .867, .922, .969}Classification & \cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\
...
&  \cellcolor[rgb]{ .867, .922, .969}Cascade Routing~\cite{dekoninck2024unified}	& \cellcolor[rgb]{ .867, .922, .969}Unsupervised & \cellcolor[rgb]{ .867, .922, .969}Class uncertainty  & \cellcolor[rgb]{ .867, .922, .969}$>2$  &\cellcolor[rgb]{ .867, .922, .969}Routing-equipped &\cellcolor[rgb]{ .867, .922, .969}\cmark  &\cellcolor[rgb]{ .867, .922, .969}Classification  &\cellcolor[rgb]{ .867, .922, .969}\href{https://github.com/eth-sri/cascade-routing}{\textcolor{gray}{[Link]}} \\

&  \cite{jitkrittum2024does}	& Supervised & (Upgraded) Class unc. & $\geq2$$^{\dag}$ & Post-hoc deferral & \cmark & Classification & \textcolor{gray}{-} \\

&  \cellcolor[rgb]{ .867, .922, .969}FrugalGPT~\cite{chen2023frugalgpt} 	& \cellcolor[rgb]{ .867, .922, .969}Supervised &  \cellcolor[rgb]{ .867, .922, .969}Score function  &\cellcolor[rgb]{ .867, .922, .969}$\geq2$& \cellcolor[rgb]{ .867, .922, .969}Prompt engineering, etc.& \cellcolor[rgb]{ .867, .922, .969}\cmark &  \cellcolor[rgb]{ .867, .922, .969}Query answering &\cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\

&  \cite{gupta2024language} 	& Supervised & Score function 
& $=2$ & Quantile features & \cmark & Generation & \textcolor{gray}{-}\\

&  \cellcolor[rgb]{ .867, .922, .969}AutoMix~\cite{aggarwal2023automix}	& \cellcolor[rgb]{ .867, .922, .969}Supervised & \cellcolor[rgb]{ .867, .922, .969}MDP &\cellcolor[rgb]{ .867, .922, .969}$\geq2$ &\cellcolor[rgb]{ .867, .922, .969}Routing-equipped, etc.&\cellcolor[rgb]{ .867, .922, .969}\cmark &\cellcolor[rgb]{ .867, .922, .969}Reasoning &\cellcolor[rgb]{ .867, .922, .969}\textcolor{gray}{-}\\
...
From the perspective of ensemble strategy, \textit{aggregation} methods (involving the average or weighted ensemble of all model outputs) are more sophisticated compared to \textit{selection}-based methods, which select a single output (equivalent to a \textit{hard voting} process). 
